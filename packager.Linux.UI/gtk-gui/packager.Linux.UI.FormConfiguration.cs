...
namespace packager.Linux.UI
{
	public partial class FormConfiguration
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget packager.Linux.UI.FormConfiguration
			this.Name = "packager.Linux.UI.FormConfiguration";
			this.Title = global::Mono.Unix.Catalog.GetString ("dialog1");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child packager.Linux.UI.FormConfiguration.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child packager.Linux.UI.FormConfiguration.ActionArea
